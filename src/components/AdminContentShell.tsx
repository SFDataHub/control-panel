...
const SURFACE: CSS = { borderColor: "#1F3150", background: "linear-gradient(180deg, #0f1624 0%, #0b111d 100%)" };
const RAIL: CSS = { borderColor: "#1F3150", background: "linear-gradient(180deg, #0f1727 0%, #0b1220 100%)" };
